...
// */
//class GoogleBookConnectionViewOld extends VBox {
//
...
//    private final Cache<@NotNull String, @NotNull Volume> cache;
//
...
//    private final ObjectProperty<Volume> currentVolume = new SimpleObjectProperty<>();
...
//    }
//
//    private Cache<@NotNull String, @NotNull Volume> buildCache() {
...
//        final Volume volume = currentVolume.get();
//        if (handle != null) {
//            logger.debug("Creating cache for: '{}'...", currentGoogleHandle.get());
//            cache.put(handle, volume);
...
//        Volume volume = cache.getIfPresent(googleBookLink);
//        if (volume != null) {
