package com.dansoftware.boomega.gui.googlebooks.tile
...
class GoogleBookTile(
    ...
    private class Thumbnail(volume: Volume) : StackPane() {
        ...
        private class PlaceHolder : Label(I18N.getValue("google.books.table.thumbnail.not.available"))
    }
    ...
    private class Info(volume: Volume) : VBox(5.0) {
        ...
        private fun buildMarkLabel() =
            HBox(10.0, ImageView(Image("/com/dansoftware/boomega/image/util/google_12px.png")),
                Label(I18N.getValue("google.books.tile.title")).also {
