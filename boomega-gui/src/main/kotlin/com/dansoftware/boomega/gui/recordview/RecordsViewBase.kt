...
class RecordsViewBase(
    ...
    private val preferences: com.dansoftware.boomega.config.Preferences,
    ...
    var docksList: List<Dock>
        get() = dockSplitPane.items.filterIsInstance<com.dansoftware.boomega.gui.recordview.dock.DockView<*>>().mapNotNull(
            com.dansoftware.boomega.gui.recordview.dock.DockView<*>::getDockEnum)
        set(value) {
            docks.setAll(value)
        }
